...
export default function Reports() {
    ...
    const loadCampersByBunk = async () => {
        const response = await fetch("https://summer-camp-emr-env.eba-ybkpfisp.us-east-1.elasticbeanstalk.com/api/Reports/campers-by-bunk");
        if (!response.ok) {
    ...
    const loadAllergies = async () => {
        const response = await fetch("https://summer-camp-emr-env.eba-ybkpfisp.us-east-1.elasticbeanstalk.com/api/reports/allergies");
        const json = await response.json();
        setData(json);
    ...
    const loadMedications = async () => {
        const response = await fetch("https://summer-camp-emr-env.eba-ybkpfisp.us-east-1.elasticbeanstalk.com/api/reports/medications");
        const json = await response.json();
        setData(json);
