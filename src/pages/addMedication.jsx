...
export default function AddMedication() {
    ...
    useEffect(() => {
        fetch('https://krb11kwl6k.execute-api.us-east-1.amazonaws.com/api/Medications')
        ...
        const handleSubmit = async (e) => {
            ...
            const response = await fetch('https://krb11kwl6k.execute-api.us-east-1.amazonaws.com/api/CamperMedications', {
                method: 'POST',
                headers: {
