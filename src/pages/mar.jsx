...
export default function MAR() {
    ...
    const loadMAR = () => {
        fetch('https://summer-camp-emr-env.eba-ybkpfisp.us-east-1.elasticbeanstalk.com/api/MAR')
    ...
    const handleAdminister = async (camperMedicationId) => {
        const response = await fetch(`https://summer-camp-emr-env.eba-ybkpfisp.us-east-1.elasticbeanstalk.com/api/MAR/administer/${camperMedicationId}`, {
            method: 'POST'
        });
